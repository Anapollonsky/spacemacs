;;; apples-theme.el --- A fruity color theme for Emacs.

;; Copyright (C) 2011-2013

;; Author: Kelvin Smith <oneKelvinSmith@gmail.com>
;; URL: https theme requires Emacs 24 or later!"))


(deftheme apples "The apples colour theme")
...
(let* ((class                    '((class color) (min-colors 257)))
       ...
       ;; Adaptive colors
       (terminal-apples-fg               "#F5F5F5")
       (terminal-apples-bg               "#1B1E1C")
       (terminal-apples-hl-line          "#212121")
       (terminal-apples-hl               "#303030")
       (terminal-apples-emph             "#FFFAFA")
       (terminal-apples-comments         "#8B8878")
       ;; Adaptive higher/lower contrast accented colors
       (terminal-apples-fg-hc            "#171A0B")
       (terminal-apples-fg-lc            "#141414")
       ;; High contrast colors
       ...
       ;; customize based face properties
       (terminal-s-variable-pitch         (if apples-use-variable-pitch
                                              'variable-pitch 'default))
       (terminal-s-fringe-bg              (if apples-distinct-fringe-background
                                              terminal-apples-hl terminal-apples-bg))
       (terminal-s-mode-line-fg           (if apples-high-contrast-mode-line
                                              terminal-apples-bg terminal-apples-fg))
       (terminal-s-mode-line-bg           (if apples-high-contrast-mode-line
                                              terminal-apples-fg terminal-apples-hl-line))
       (terminal-s-mode-line-buffer-id-fg (if apples-high-contrast-mode-line
                                              'unspecified terminal-green))
       (terminal-s-mode-line-inactive-fg  (if apples-high-contrast-mode-line
                                              terminal-apples-fg terminal-apples-comments))
       (terminal-s-mode-line-inactive-bg  (if apples-high-contrast-mode-line
                                              terminal-apples-hl-line terminal-apples-bg))
       (terminal-s-mode-line-inactive-bc  (if apples-high-contrast-mode-line
                                              terminal-apples-fg terminal-apples-hl-line)))
  ...
  (custom-theme-set-faces
   ...
   `(default
      ((,class (:foreground ,apples-fg
       ...
       (,terminal-class (:foreground ,terminal-apples-fg
                                     :background ,terminal-apples-bg))))
   ...
   `(match
     ((,class (:background ,apples-hl
                           ...
                           :weight bold))
      (,terminal-class (:background ,terminal-apples-hl
                                    :foreground ,terminal-apples-emph
                                    :weight bold))))
   ...
   `(cursor
     ((,class (:foreground ,apples-bg
                           ...
                           :inverse-video t))
      (,terminal-class (:foreground ,terminal-apples-bg
                                    :background ,terminal-apples-fg
                                    :inverse-video t))))
   ...
   `(cua-rectangle-noselect
     ((,class (:inherit region
      ...
      (,terminal-class (:inherit region
                                 :background ,terminal-apples-hl
                                 :foreground ,terminal-apples-comments))))
   ...
   `(ecb-tree-guide-line-face
     ((,class (:inherit ecb-default-general-face
                        :foreground ,apples-hl
                        :height 1.0))
      (,terminal-class (:inherit ecb-default-general-face
                                 :foreground ,terminal-apples-hl
                                 :height 1.0))))

   ;; ee
   `(ee-bookmarked
     ((,class (:foreground ,apples-emph))
      (,terminal-class (:foreground ,terminal-apples-emph))))
   ...
   `(evil-search-highlight-persist-highlight-face
     ((,class (:background ,apples-hl-line))
      (,terminal-class (:background ,terminal-apples-hl-line))))
   ...
   `(vertical-border
     ((,class (:foreground ,apples-hl))
      (,terminal-class (:foreground ,terminal-apples-hl))))
   ...
   `(font-latex-italic-face
     ((,class (:inherit italic :foreground ,apples-emph))
      (,terminal-class (:inherit italic :foreground ,terminal-apples-emph))))
   ...
   `(font-latex-subscript-face
     ((,class (:height ,apples-height-minus-1))
      (,terminal-class (:height ,apples-height-minus-1))))
   ...
   `(ctbl:face-cell-select
     ((,class (:background ,apples-hl
                           :foreground ,apples-emph
                           :underline ,apples-emph
                           :weight bold))
      (,terminal-class (:background ,terminal-apples-hl
                                    :foreground ,terminal-apples-emph
                                    :underline ,terminal-apples-emph
                                    :weight bold))))
   ...
   `(diff-header
     ((,class (:background ,apples-bg))
      (,terminal-class (:background ,terminal-apples-bg))))
   ...
   `(gnus-x-face
     ((,class (:background ,apples-fg
                           :foreground ,apples-bg))
      (,terminal-class (:background ,terminal-apples-fg
                                    :foreground ,terminal-apples-bg))))
   ...
   `(org-agenda-structure
     ((,class (:foreground ,apples-emph
      ...
      (,terminal-class (:foreground ,terminal-apples-emph
                                    ...
                                    :height ,apples-height-plus-1
                                    :underline nil
                                    :box (:line-width 2 :color ,terminal-apples-bg)))))
   ...
   `(org-agenda-date
     ((,class (:foreground ,apples-comments
      ...
      (,terminal-class (:foreground ,terminal-apples-comments
                                    ...
                                    :slant normal
                                    :height 1.0
                                    :box (:line-width 2 :color ,terminal-apples-bg)))) t)
   ...
   `(org-agenda-date-today
     ((,class (:inherit org-agenda-date
      ...
      (,terminal-class (:inherit org-agenda-date
                                 ...
                                 :box unspecified
                                 :foreground ,terminal-blue
                                 :background ,terminal-apples-bg))) t)
   ...
   ;; parenface
   `(paren-face
     ((,terminal-class (:foreground ,apples-comments))))
   ...
   `(popup-scroll-bar-foreground-face
     ((,class (:background ,apples-emph))
      (,terminal-class (:background ,terminal-apples-emph))))
   ...
   `(whitespace-newline
     ((,class(:background unspecified
                          :foreground ,apples-whitespace-bright
                          :inverse-video unspecified))
      (,terminal-class(:background unspecified
                                   :foreground ,terminal-apples-comments
                                   :inverse-video unspecified))))
   ...
   `(yascroll:thumb-text-area
     ((,class (:foreground ,apples-comments
      ...
      (,terminal-class (:foreground ,terminal-apples-comments
                                    :background ,terminal-apples-comments))))
  ...
  (custom-theme-set-variables
   ...
   ;; weechat
   `(weechat-color-list
     (unspecified ,apples-bg ,apples-hl
                  ,red-d ,red
                  ,green-d ,green
                  ,yellow-d ,yellow
                  ,blue-d ,blue
